...
const Contact = () => {
  const textstyle="text-[#b6b3b3] opacity-70 font-sans lg:text-[15px] text-sm"
  return (
    <>
    <div className='flex justify-center mt-10 flex-col items-center gap-4 bg-[#0b0b0b] p-5'>
      <p className={`glow hover:text-black transition duration-500 text-[#ffffff] font-serif opacity-60 lg:text-[23px] text-2xl `}>Get in touch with me !</p>
